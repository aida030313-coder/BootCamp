...
// 1. 웹캠 켜기(웹캠 스트림 연결): navigator.mediaDevices.getUserMedia 활용
...
export default function Step2() {
  ...
  useEffect(() => {
    ...
    const detectFrame = async () => {
      ...
      rafRef.current = requestAnimationFrame(detectFrame); // 그 다음 프레임 그릴 때 예약(루프)
    };
    rafRef.current = requestAnimationFrame(detectFrame); // 최초의 프레임 그릴 때 예약
